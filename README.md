...
**Parameters:**
- `page` (Query): Integer - Page number for pagination- `limit` (Query): Integer - Number of items per page- `status` (Query): String - Filter users by status- `sort` (Query): String - Sort field and order- `X-Request-ID` (Header): String - Unique request identifier
---
...
**Parameters:**
- `category` (Query): Array - Filter by categories- `minPrice` (Query): Number- `maxPrice` (Query): Number- `inStock` (Query): Boolean
---
...
**Parameters:**
- `status` (Query): String- `startDate` (Query): String- `endDate` (Query): String
---
...
**Parameters:**
- `q` (Query) **[required]**: String - Search query- `type` (Query): Array - Resource types to search
---
...
**Generated on:** 2026-01-22 14:45:33 UTC
